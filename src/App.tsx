...
const IMAGE_ATHLETE = "/src/assets/images/athlete_performance_1781030034584.png";
...
export default function App() {
  ...
  const getCalculationResults = () => {
    ...
    if (calcGoal === "emagrecimento") bodyFatTarget = "Redução em busca de 12-18%";
    if (calcGoal === "saude") bodyFatTarget = "Equilíbrio saudável entre 14-22%";
    ...
    return {
      ...
      pillarGoalText: 
        calcGoal === "emagrecimento" ? "Maximizar queima lipídica preservando massa magra." :
        calcGoal === "hipertrofia" ? "Superávit calórico controlado e estímulo mecânico progressivo." :
        calcGoal === "performance" ? "Periodização nutricional esportiva e aporte de carboidratos complexos." :
  ...
  const allTags = ["Todos", ...Array.from(new Set(REVIEWS_DATA.flatMap(r => r.tags)))];
  ...
  const handlePrevReview = () => {
    setActiveReviewIndex((prev) => (prev - 1 + filteredReviews.length) % filteredReviews.length);
  };
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 selection:bg-brand selection:text-black">
      ...
      {/* HEADER SECTION */}
      <header id="main-header" className="sticky top-0 z-40 bg-black/80 backdrop-blur-md border-b border-zinc-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          
          {/* Brand/Logo */}
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-zinc-900 border border-brand flex items-center justify-center relative shadow-md">
              <span className="text-brand font-black text-xl tracking-tight">FP</span>
              <div className="absolute inset-0 bg-brand/10 rounded-lg animate-pulse"></div>
            </div>
            <div>
              <span className="font-extrabold text-lg text-white tracking-tight uppercase block leading-none">
                Dr. Fábio Pizzini
              </span>
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium font-display">
            <a href="#home" className="text-zinc-300 hover:text-brand transition-colors">HOME</a>
            <a href="#ajuda" className="text-zinc-300 hover:text-brand transition-colors">ATUAÇÃO</a>
            <a href="#quem-vai-ajudar" className="text-zinc-300 hover:text-brand transition-colors">O MÉDICO</a>
            <a href="#nutrologia" className="text-zinc-300 hover:text-brand transition-colors">NUTROLOGIA</a>
            <a href="#avaliacao" className="text-zinc-300 hover:text-brand transition-font border-b border-transparent hover:border-brand/30 text-brand flex items-center gap-1.5 bg-brand/5 px-2.5 py-1 rounded">
            ...
            <a href="#contato" className="text-zinc-300 hover:text-brand transition-colors">CONTATO</a>
          </nav>
          ...
          <div className="md:hidden border-t border-zinc-900 bg-black/95 px-4 pt-4 pb-6 space-y-3 font-display">
            ...
            <div className="pt-4 flex flex-col gap-2">
              ...
              <div className="flex justify-center gap-6 pt-3 text-zinc-400">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-brand"><Instagram className="w-5 h-5" /></a>
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:text-brand"><Video className="w-5 h-5" /></a>
                <a href="https://spotify.com" target="_blank" rel="noopener noreferrer" className="hover:text-brand"><TrendingUp className="w-5 h-5" /></a>
              </div>
            </div>
          </div>
        )}
      ...
      <section id="home" className="relative pt-6 pb-20 md:py-28 overflow-hidden">
            ...
            <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
              ...
              <div className="space-y-4">
                <h1 className="text-4xl sm:text-5xl md:text-6.5xl font-black text-white tracking-tight leading-tight uppercase font-display">
                  Você na sua <span className="lime-text-gradient block">melhor versão</span> física e metabólica.
                </h1>
                <p className="text-zinc-400 text-base sm:text-lg max-w-2xl mx-auto lg:mx-0 leading-relaxed font-sans">
                  A melhor opção em <strong className="text-white">emagrecimento</strong>, <strong className="text-white">nutrologia esportiva</strong> e <strong className="text-white">treinamento físico personalizado</strong> de Sorocaba com foco absoluto em ciência, metabolismo e resultados práticos e duradouros.
                </p>
              </div>
              ...
              <div className="pt-6 border-t border-zinc-900/80 max-w-md mx-auto lg:mx-0 flex items-center justify-center lg:justify-start gap-6">
                <div>
                  ...
                  <p className="text-[11px] text-zinc-500 font-mono tracking-widest uppercase">EXCELENTE · GOOGLE RATINGS</p>
                </div>
                <div className="h-8 w-px bg-zinc-900"></div>
                <div className="text-left">
                  <p className="text-lg font-black text-white font-display leading-tight">153+</p>
                  <p className="text-[10.5px] text-zinc-400 font-sans">Avaliações reais de pacientes ativos</p>
                </div>
              </div>

            </div>

            {/* Column 2: Gorgeous Moody Visual Container */}
            <div className="lg:col-span-5 relative">
              <div className="relative mx-auto max-w-md lg:max-w-none">
                
                {/* Visual Circle framing */}
                <div className="absolute inset-0 bg-gradient-to-tr from-brand/10 to-transparent rounded-3xl -rotate-3 transform scale-102"></div>
                
                {/* Main Image Container */}
                <div className="relative bg-zinc-950 border border-zinc-800/80 p-3 rounded-2xl overflow-hidden shadow-2xl">
                  <img 
                    src={IMAGE_ATHLETE} 
                    alt="Treinamento de Performance Esportiva" 
                    className="w-full h-[320px] sm:h-[420px] object-cover rounded-xl grayscale-10 hover:grayscale-0 transition-all duration-700"
                    referrerPolicy="no-referrer"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent pointer-events-none"></div>
                  
                  {/* Floating Metric HUD Overlay to make it feel super-high-tech sports medicine */}
                  <div className="absolute bottom-6 left-6 right-6 bg-black/85 backdrop-blur-md p-4 rounded-xl border border-zinc-800 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs text-zinc-400 font-sans">Foco em Performance</p>
                        <p className="text-sm font-extrabold text-white leading-none font-display">HIPERTROFIA & DEFINIÇÃO</p>
                      </div>
                    </div>
                    <span className="text-[11px] font-mono bg-brand/10 text-brand font-bold py-1 px-2.5 rounded border border-brand/20">
                      METABOLISMO ATIVO
                    </span>
                  </div>
                </div>

                {/* Micro floating widget indicating high satisfaction */}
                <div className="absolute -top-4 -right-4 bg-zinc-900 border border-zinc-800 px-4 py-3 rounded-xl shadow-xl hidden sm:flex items-center gap-2">
                  <CheckCircle className="w-6 h-6 text-brand" />
                  <div>
                    <p className="text-[9px] text-zinc-500 uppercase font-mono tracking-widest leading-none">Padrão Ouro</p>
                    <p className="text-xs font-bold text-white font-sans">3 Pilares Sincronizados</p>
                  </div>
                </div>
      ...
      <section id="ajuda" className="py-20 bg-zinc-950 border-y border-zinc-900 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
            ...
            <p className="text-zinc-400 text-sm sm:text-base leading-relaxed">
              Estamos prontos para mostrar o caminho correto, seguro e mais eficaz para você atingir seus objetivos estéticos e metabólicos sem restrições extremas ou modismos.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="group bg-black border border-zinc-850 p-6 rounded-2xl hover:border-brand/40 transition-all duration-300 relative flex flex-col justify-between hover:-translate-y-1">
              <div>
                ...
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-sans">
                  Através de uma análise detalhada de toda sua rotina, vamos ajustar tudo, para que tenha total condição de emagrecer com saúde e qualidade, seja para fins de saúde ou mesmo para definição muscular.
                </p>
              </div>
              <div className="mt-6 pt-6 border-t border-zinc-900/80 flex items-center justify-between">
                <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">METABOLIC ACCURACY</span>
            ...
            <div className="group bg-black border border-zinc-850 p-6 rounded-2xl hover:border-brand/40 transition-all duration-300 relative flex flex-col justify-between hover:-translate-y-1">
              <div>
                ...
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-sans">
                  Você deseja ganhar massa muscular? Vamos te dar todas as diretrizes a serem seguidas para que atinja esse objetivo de forma eficaz e com total segurança metabólica e ortopédica.
                </p>
              </div>
              <div className="mt-6 pt-6 border-t border-zinc-900/80 flex items-center justify-between">
                <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">MUSCULAR GROWTH</span>
                <Sparkles className="w-4 h-4 text-brand opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
            </div>
            ...
            <div className="group bg-black border border-zinc-850 p-6 rounded-2xl hover:border-brand/40 transition-all duration-300 relative flex flex-col justify-between hover:-translate-y-1">
              <div>
                ...
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-sans">
                  Para você que é um atleta amador ou profissional e deseja melhorar seu desempenho e potencializar seus resultados, temos uma estratégia personalizada que será ajustada para sua individualidade.
                </p>
              </div>
              <div className="mt-6 pt-6 border-t border-zinc-900/80 flex items-center justify-between">
                <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">SPORTS MEDICINE</span>
                <Sparkles className="w-4 h-4 text-brand opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
            </div>
            ...
            <div className="group bg-black border border-zinc-850 p-6 rounded-2xl hover:border-brand/40 transition-all duration-300 relative flex flex-col justify-between hover:-translate-y-1">
              <div>
                ...
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-sans">
                  Se o seu objetivo é simplesmente uma alimentação equilibrada e saudável, visando saúde e qualidade de vida, daremos todas as informações necessárias para que tenha sucesso nessa mudança de forma sustentada.
                </p>
              </div>
              <div className="mt-6 pt-6 border-t border-zinc-900/80 flex items-center justify-between">
                <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">LONGEVITY OPTIMIZATION</span>
                <Sparkles className="w-4 h-4 text-brand opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
            </div>
          ...
          <div className="mt-12 bg-zinc-900/65 rounded-2xl border border-zinc-800/85 p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-white font-bold leading-tight font-display text-lg">CONSULTA INTEGRADA & PARAMENTOS REAIS</h4>
                <p className="text-zinc-450 text-xs sm:text-sm mt-0.5 max-w-2xl font-sans">
                  Nosso acompanhamento conta com anamnese médica completa, acompanhamento hormonal e mapeamento estético para direcionamento de bioimpedância de alta definição.
                </p>
              </div>
            </div>
            <a 
      ...
      <section id="quem-vai-ajudar" className="py-20 lg:py-28 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="relative max-w-sm sm:max-w-md mx-auto">
                ...
                <div className="relative bg-zinc-950 border-2 border-zinc-800 p-2 sm:p-3 rounded-2.5xl overflow-hidden shadow-2xl">
                  ...
                  <div className="absolute top-6 left-6 bg-black/85 backdrop-blur-md px-3.5 py-1.5 rounded-lg border border-zinc-800 flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-white">RQE 130.636</span>
                  </div>
                  ...
                  <div className="absolute bottom-6 left-6 right-6 bg-black/85 backdrop-blur-md p-4 rounded-xl border border-zinc-850">
                    <span className="text-[9px] text-brand font-mono font-bold tracking-widest uppercase block mb-1">MÉDICO DO ESPORTE & NUTRÓLOGO</span>
                    <span className="text-lg font-black text-white font-display uppercase tracking-tight block">FÁBIO PIZZINI</span>
                    <span className="text-[10.5px] text-zinc-400 font-sans block mt-1">Pontifícia Universidade Católica de SP</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="space-y-4">
                <span className="text-xs font-mono text-brand font-bold tracking-widest uppercase block">QUEM VAI AJUDAR VOCÊ</span>
              ...
              <p className="text-zinc-300 text-sm sm:text-base leading-relaxed font-sans">
                Formado em Medicina pela renomada <strong>Pontifícia Universidade Católica de São Paulo – PUC/SP</strong>, o Dr. Fábio Pizzini é especialista em entregar as ferramentas clínicas e hormonais necessárias para alinhar biotipo, saúde interna e performance diária.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-1/1 md:grid-cols-1 gap-4">
                ...
                <div className="flex gap-4 p-4 rounded-xl bg-zinc-950/70 border border-zinc-900 hover:border-zinc-800 transition-colors">
                  ...
                  <div>
                    <h4 className="text-white text-sm font-bold font-display uppercase">Médico do Esporte Certificado</h4>
                    <p className="text-zinc-400 text-xs sm:text-sm mt-0.5">
                      Sociedade Brasileira de Medicina do Exercício e do Esporte – RQE 130.636. Capacitação integral em biologia do movimento.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 rounded-xl bg-zinc-950/70 border border-zinc-900 hover:border-zinc-800 transition-colors">
                  ...
                  <div>
                    <h4 className="text-white text-sm font-bold font-display uppercase">Pós-Graduação Dupla em Nutrologia</h4>
                    <p className="text-zinc-400 text-xs sm:text-sm mt-0.5">
                      Associação Brasileira de Nutrologia – ABRAN. Pós-Graduado em Nutrologia e Nutrologia Esportiva.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 rounded-xl bg-zinc-950/70 border border-zinc-900 hover:border-zinc-800 transition-colors">
                  ...
                  <div>
                    <h4 className="text-white text-sm font-bold font-display uppercase">Advanced Nutrition Specialist</h4>
                    <p className="text-zinc-400 text-xs sm:text-sm mt-0.5">
                      Certificação internacional pela International Federation of Body Building and Fitness – IFBB.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 rounded-xl bg-zinc-950/70 border border-zinc-900 hover:border-zinc-800 transition-colors">
                  ...
                  <div>
                    <h4 className="text-white text-sm font-bold font-display uppercase">Capacitação em Nutrologia do Exercício</h4>
                    <p className="text-zinc-400 text-xs sm:text-sm mt-0.5">
                      Associação Brasileira de Nutrologia – ABRAN. Estudo metabólico voltado a rendimento esportivo.
                    </p>
                  </div>
                </div>
              ...
              <div className="border-l-2 border-brand pl-4 py-1 italic text-zinc-400 text-sm">
                "Não existem metas inatingíveis quando combinamos a bioquímica médica, a nutrição funcional e o treino planejado. O sucesso é fruto de pilares inteligentes, e nós fornecemos a ponte."
              </div>
      ...
      <section id="nutrologia" className="py-20 bg-zinc-950 border-y border-zinc-900 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="space-y-3">
                <span className="text-xs font-mono text-brand font-bold tracking-widest uppercase block">CONHECIMENTO MÉDICO</span>
                <h2 className="text-3xl sm:text-4.5xl font-black text-white uppercase tracking-tight font-display">
                  Entenda a Ciência da Nutrologia
                </h2>
                <p className="text-zinc-400 text-sm leading-relaxed max-w-2xl font-sans">
                  A Nutrologia clínica é a especialidade focada em entender as respostas celulares ao que ingerimos, otimizando o metabolismo para prevenção, estética física e recuperação corporal completa.
                </p>
              </div>
              ...
              <div className="bg-black border border-zinc-850 p-6 rounded-2xl relative overflow-hidden">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <span className="text-xs font-mono text-zinc-400 uppercase tracking-widest block mb-1">A Definição Oficial</span>
                    <p className="text-white text-sm sm:text-base font-medium leading-relaxed font-sans">
                      “Nutrologia é a especialidade médica que estuda, pesquisa e avalia os benefícios e malefícios causados pela ingestão dos nutrientes, aplicando este conhecimento para a avaliação de nossas necessidades orgânicas, visando a manutenção da saúde e redução de risco de doenças [...]”.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  <span className="text-brand text-xs font-mono font-bold tracking-wider uppercase block">01 / COMPLEMENTO</span>
                  <h4 className="text-white text-sm font-extrabold uppercase font-display leading-tight">Visão Transversal</h4>
                  <p className="text-zinc-400 text-xs sm:text-sm font-sans leading-relaxed">
                    A Nutrologia caminha lado a lado com endocrinologia, cardiologia e fisiologia esportiva. Mapeamos desequilíbrios hormonais e metabólicos com precisão médica.
                  </p>
                </div>

                {/* Item B: Benefícios */}
                <div className="space-y-2">
                  <span className="text-brand text-xs font-mono font-bold tracking-wider uppercase block">02 / BENEFÍCIOS</span>
                  <h4 className="text-white text-sm font-extrabold uppercase font-display leading-tight">Energia & Imunidade</h4>
                  <p className="text-zinc-400 text-xs sm:text-sm font-sans leading-relaxed">
                    Melhora acentuada nos níveis de cansaço crônico, modulação do estresse oxidativo celular e prevenção de riscos metabólicos de longo prazo.
                  </p>
                </div>

                {/* Item C: Objetivos */}
                <div className="space-y-2">
                  <span className="text-brand text-xs font-mono font-bold tracking-wider uppercase block">03 / OBJETIVOS</span>
                  <h4 className="text-white text-sm font-extrabold uppercase font-display leading-tight">Longevidade Real</h4>
                  <p className="text-zinc-400 text-xs sm:text-sm font-sans leading-relaxed">
                    Mais que estética passageira: desenhamos um roteiro fisiológico personalizado para manter massa magra ativa e queima lipídica constante por anos.
                  </p>
                </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative mx-auto max-w-sm sm:max-w-md">
                ...
                <div className="absolute -bottom-4 -left-4 bg-zinc-900 border border-zinc-800 p-4 rounded-xl shadow-2xl flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-[10px] text-zinc-400 font-mono block">Bioimpedância Segmentada</span>
                    <strong className="text-white text-xs block font-display tracking-wide uppercase">Mapeamento InBody</strong>
                  </div>
                </div>
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
            ...
            <p className="text-zinc-400 text-sm sm:text-base leading-relaxed">
              Muitas pessoas tentam treinar e comer bem, mas continuam frustradas. Antes de entender os erros, conheça os dois caminhos clínicos que você pode trilhar:
            </p>
          </div>
            ...
            <div className="lg:col-span-4 space-y-4 font-display">
              ...
              >
                <div className="flex items-center gap-2.5 mb-2">
                  <span className={`w-2.5 h-2.5 rounded-full ${selectedPath === 1 ? "bg-red-500" : "bg-zinc-650"}`}></span>
                  <span className="text-[10px] font-mono tracking-widest uppercase">CAMINHO 1</span>
                </div>
                <h4 className="text-base sm:text-lg font-black uppercase text-zinc-100 group-hover:text-white">Plano Genérico de Internet</h4>
                <p className="text-zinc-500 text-xs mt-1.5 font-sans leading-relaxed">Fórmulas prontas, modas de blogueres e suor sem direção médica.</p>
              </button>
              ...
              >
                <div className="absolute top-4 right-4 bg-brand text-black text-[9px] font-mono font-black px-1.5 py-0.5 rounded leading-none">RECOMENDADO</div>
                <div className="flex items-center gap-2.5 mb-2">
                  <span className={`w-2.5 h-2.5 rounded-full ${selectedPath === 2 ? "bg-brand animate-ping" : "bg-zinc-650"}`}></span>
                  <span className="text-[10px] font-mono tracking-widest uppercase">CAMINHO 2</span>
                </div>
                <h4 className="text-base sm:text-lg font-black uppercase text-white">Método Médico Personalizado</h4>
                <p className="text-zinc-450 text-xs mt-1.5 font-sans leading-relaxed">Exames clínicos integrados, ajuste bioquímico real e treino científico.</p>
              </button>
            </div>
                ...
                {selectedPath === 1 ? (
                  <div className="space-y-4">
                    ...
                    <p className="text-zinc-300 text-xs sm:text-sm leading-relaxed font-sans">
                      Seguir planos prontos de internet sem considerar as necessidades individuais, sem uma avaliação interna séria de sangue/hormônios ou um plano de exercícios personalizado, resulta em perdas bruscas de massa muscular, cansaço em excesso, colaterais inadequados e frustrações recorrentes.
                    </p>
                    <div className="p-3 bg-red-950/25 border border-red-900/30 rounded-xl text-xs text-red-400 font-sans">
                      <strong>Consequência comum:</strong> Efeito sanfona severo e degradação da energia do sistema mitocondrial.
                    </div>
                  </div>
                ) : (
                  <div className="space-y-4">
                    ...
                    <p className="text-zinc-300 text-xs sm:text-sm leading-relaxed font-sans">
                      O caminho para o sucesso é construído com base em exames clínicos, orientação médica profissional rigorosa, adequação de micronutrientes, correção hormonal e um roteiro de treinos personalizado feito pelas mentes mais competentes do esporte. O resultado natural é o ganho de massa magra, redução da gordura visceral e melhora acentuada do estilo de vida metabólico.
                    </p>
                    <div className="p-3 bg-brand/5 border border-brand/10 rounded-xl text-xs text-zinc-300 font-sans flex items-center gap-2">
                      ...
                      <span><strong>Diferencial clínico:</strong> Alinhamento com endocrinologia e nutrologia do exercício para desempenho contínuo.</span>
                    </div>
                  </div>
                )}
              </div>
          ...
          <div className="bg-zinc-950 border border-zinc-900/80 p-6 sm:p-8 rounded-2xl">
            <h3 className="text-lg sm:text-xl font-black text-white font-display uppercase text-center mb-10 tracking-wider">
              Veja abaixo os <span className="text-brand">3 Erros Cruciais</span> que você precisa evitar:
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-6 rounded-xl bg-black border border-zinc-850 hover:border-red-500/20 transition-all duration-300">
                <span className="text-[10px] font-mono text-red-500 block mb-2 font-black uppercase tracking-widest">PITFALL 01 //</span>
                <h4 className="text-lg font-bold font-display text-white uppercase mb-3">01. Não ter acompanhamento médico</h4>
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-sans">
                  Tentar ajustar a bioquímica e o metabolismo corporal por conta própria, ignorando exames hormonais importantes, marcadores inflamatórios e possíveis deficiências crônicas de micronutrientes essenciais.
                </p>
              </div>

              {/* ERRO 2 */}
              <div className="p-6 rounded-xl bg-black border border-zinc-850 hover:border-red-500/20 transition-all duration-300">
                <span className="text-[10px] font-mono text-red-500 block mb-2 font-black uppercase tracking-widest">PITFALL 02 //</span>
                <h4 className="text-lg font-bold font-display text-white uppercase mb-3">02. Não ter orientação nutricional</h4>
                <p className="text-zinc-405 text-xs sm:text-sm leading-relaxed font-sans">
                  Seguir dietas restritivas extremas da internet sem a individualização biológica necessária para o seu nível de atividade diária, gerando indisposição e perda de massa muscular importante.
                </p>
              </div>

              {/* ERRO 3 */}
              <div className="p-6 rounded-xl bg-black border border-zinc-850 hover:border-red-500/20 transition-all duration-300">
                <span className="text-[10px] font-mono text-red-500 block mb-2 font-black uppercase tracking-widest">PITFALL 03 //</span>
                <h4 className="text-lg font-bold font-display text-white uppercase mb-3">03. Não ter auxílio nos treinos</h4>
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-sans">
                  Treinar sem periodização correta ou sem o direcionamento de intensidade ideal para estimular de fato a hipertrofia e ativar receptores metabólicos necessários para mobilizar gordura subcutânea.
                </p>
              </div>

            </div>

            {/* Crucial conclusion statement block */}
            <div className="mt-8 pt-8 border-t border-zinc-900/80 text-center max-w-2xl mx-auto space-y-3">
              <strong className="text-white text-base font-display uppercase tracking-wider block">
                Por mais simples que isso pareça, é exatamente onde a maioria das pessoas erram!
              </strong>
              <p className="text-zinc-400 text-xs leading-relaxed font-sans">
                Agora que você conhece esses bloqueios biológicos, não os repetirá! O sucesso verdadeiro vem do perfeito alinhamento dos 3 pilares vitais: <span className="text-brand font-bold">médico, nutricional e de treinamento direcionado</span>.
              </p>
            </div>
          </div>
      ...
      <section id="avaliacao" className="py-20 bg-zinc-950 border-y border-zinc-900 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="space-y-4">
                <span className="text-xs font-mono text-brand font-mono font-bold tracking-widest uppercase block">AVALIE-SE AGORA</span>
                ...
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-sans">
                  Insira seus dados físicos atuais para entender um direcionamento preliminar dos seus de água metabólica, de proteína diária estrutural para preservação e o que deve buscar em sua bioimpedância segmentada.
                </p>
              </div>
              ...
              <div className="bg-black border border-zinc-850 p-6 sm:p-8 rounded-2xl relative shadow-2xl space-y-6">
                ...
                <div>
                  <div className="flex justify-between items-center mb-2 font-display">
                    <label className="text-sm font-bold text-zinc-300 uppercase">Seu Peso Atual</label>
                    <span className="text-xl font-bold text-brand font-mono">{calcWeight} kg</span>
                  </div>
                  <input 
                    type="range"
                    min="40"
                ...
                <div>
                  <label className="text-sm font-bold text-zinc-300 uppercase block mb-3 font-display">Intensidade do seu Treino Corporal</label>
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    >
                      Leve / Moderado 
                      <span className="block text-[9px] lowercase font-normal text-zinc-400 mt-1">1 a 3 dias / semana</span>
                    </button>
                    ...
                    >
                      Intermediário
                      <span className="block text-[9px] lowercase font-normal text-zinc-400 mt-1">3 a 5 dias / semana</span>
                    </button>
                    ...
                    >
                      Esportista / Atleta
                      <span className="block text-[9px] lowercase font-normal text-zinc-400 mt-1">Diário / Intenso</span>
                    </button>
                ...
                {/* Objetivo Principal */}
                <div>
                  <label className="text-sm font-bold text-zinc-300 uppercase block mb-3 font-display">Meta Primária Desejada</label>
                ...
                {showCalcResult && (
                  <div className="pt-6 border-t border-zinc-900 mt-6 space-y-4">
                    <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest block font-bold">RESULTADOS ESPECUTIVOS ESTIMADOS:</span>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="bg-zinc-950 p-4 rounded-xl border border-zinc-850 flex items-center justify-between">
                        <div>
                          <p className="text-[10px] text-zinc-500 uppercase font-mono">Água Celular Recomendada</p>
                          <strong className="text-xl font-black text-white font-display uppercase tracking-wide">{calcResults.water} Litros / Dia</strong>
                        </div>
                        <CheckCircle className="w-6 h-6 text-brand" />
                      </div>
                      ...
                      <div className="bg-zinc-950 p-4 rounded-xl border border-zinc-850 flex items-center justify-between">
                        <div>
                          <p className="text-[10px] text-zinc-500 uppercase font-mono">Proteína Meta Diária</p>
                          <strong className="text-xl font-black text-white font-display uppercase tracking-wide">{calcResults.protein} g / Dia</strong>
                        </div>
                        <Dumbbell className="w-6 h-6 text-brand" />
                      </div>
                    ...
                    <div className="p-3.5 bg-zinc-950/90 rounded-xl border border-zinc-900 text-xs leading-relaxed space-y-1">
                      <p className="text-zinc-400 font-sans">
                        <strong className="text-white font-display uppercase text-[10.5px]">Estratégia Bioquímica Proposta:</strong> {calcResults.pillarGoalText}
                      </p>
                      <p className="text-[10.5px] text-zinc-500 font-mono">
                        Target Corporal Esperado no Mapeamento de Gordura: {calcResults.fatTarget}
                      </p>
                    </div>

                    {/* Actionable disclaimer with CTA linkage */}
                    <p className="text-[11px] text-zinc-500 italic mt-2 text-center text-zinc-450">
                      *Atenção: Estes dados são estimativas biológicas. O cálculo de bioimpedância clínica octapolar segmentativa real é feito fisicamente em consultório com laudo oficial.
                    </p>
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="bg-black border border-zinc-850 p-6 rounded-2xl relative">
                <h3 className="text-lg font-bold text-white uppercase tracking-tight font-display mb-4 border-b border-zinc-900 pb-3 flex items-center gap-2">
                  <FileText className="w-5 h-5 text-brand" /> Pré-Requisitos para Bioimpedância InBody
                </h3>
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed mb-4">
                  Para que os resultados do seu exame de bioimpedância de alta definição sejam perfeitamente precisos e livres de variáveis externas, siga estas exigências no consultório:
                </p>
                ...
                <ul className="space-y-3.5 text-xs text-zinc-300 font-sans">
                  ...
                  <li className="flex items-start gap-2.5">
                    <span className="w-5 h-5 shrink-0 rounded bg-brand/10 text-brand flex items-center justify-center font-mono font-bold text-[10.5px] mt-0.5">01</span>
                    <span><strong>Jejum Absoluto de 2 a 3 Horas:</strong> Não coma nem tome água em excesso nas 3 horas anteriores ao exame clínico.</span>
                  </li>

                  <li className="flex items-start gap-2.5">
                    <span className="w-5 h-5 shrink-0 rounded bg-brand/10 text-brand flex items-center justify-center font-mono font-bold text-[10.5px] mt-0.5">02</span>
                    <span><strong>Sem Exercícios Intensos nas 24h:</strong> O esforço físico vigoroso altera gravemente a distribuição hídrica muscular.</span>
                  </li>

                  <li className="flex items-start gap-2.5">
                    <span className="w-5 h-5 shrink-0 rounded bg-brand/10 text-brand flex items-center justify-center font-mono font-bold text-[10.5px] mt-0.5">03</span>
                    <span><strong>Bexiga Vazia para Execução:</strong> Realize a micção imediatamente antes do teste de impedância.</span>
                  </li>

                  <li className="flex items-start gap-2.5">
                    <span className="w-5 h-5 shrink-0 rounded bg-brand/10 text-brand flex items-center justify-center font-mono font-bold text-[10.5px] mt-0.5">04</span>
                    <span><strong>Sem Adornos Metálicos Pesados:</strong> Celulares, relógios corporais e anéis afetam as microcorrentes da bioeletrônica.</span>
                  </li>
              ...
              <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 text-center flex items-center justify-center gap-3">
                <Sparkles className="w-5 h-5 text-brand" />
                <span className="text-xs text-zinc-400 font-sans"><strong>InBody Octapolar Technology:</strong> O laudo de gordura segmentada mais confiável do esporte mundial.</span>
              </div>
      ...
      <section className="py-20 bg-black relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <div className="space-y-3">
              <span className="text-xs font-mono text-brand font-bold tracking-widest uppercase block">DEPOIMENTOS REAIS</span>
              <h2 className="text-3xl sm:text-4.5xl font-black text-white uppercase tracking-tight font-display">
                Excelente - 153 avaliações Google
              </h2>
              <p className="text-zinc-450 text-sm max-w-2xl font-sans">
                Confira o feedback sincero de quem passou pela Clínica de Sorocaba, superou e superou suas metas de hipertrofia, emagrecimento e saúde metabólica.
              </p>
            </div>
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            {filteredReviews.length > 0 ? (
              <div className="bg-zinc-950 border border-zinc-850 p-6 sm:p-10 rounded-2xl relative shadow-2xl space-y-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-zinc-900 pb-5">
                  <div className="flex items-center gap-4">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold font-display ${filteredReviews[activeReviewIndex].avatarColor}`}>
                      {filteredReviews[activeReviewIndex].initials}
                    </div>
                    <div>
                      <h4 className="text-lg font-bold text-white font-display uppercase tracking-tight">{filteredReviews[activeReviewIndex].name}</h4>
                      <p className="text-[11px] text-zinc-500 font-mono uppercase tracking-widest">{filteredReviews[activeReviewIndex].date}</p>
                    </div>
                  </div>

                  {/* Rating star display */}
                  <div className="flex items-center gap-1.5 bg-zinc-900 border border-zinc-800 px-3.5 py-1.5 rounded-lg">
                    <span className="text-zinc-300 font-bold font-mono text-xs">Excelente 5.0</span>
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-zinc-900">
                  <div className="flex flex-wrap gap-2">
                    {filteredReviews[activeReviewIndex].tags.map((tg, i) => (
                      <span key={i} className="text-[10px] font-mono bg-brand/10 text-brand border border-brand/20 py-0.5 px-2 rounded uppercase font-bold">
                        {tg}
                      </span>
                    ))}
                  </div>
              ...
              <p className="text-center text-zinc-550 italic py-10 font-sans">Sem depoimentos para o filtro selecionado.</p>
            )}
                ...
                {filteredReviews.map((_, idx) => (
                  <button
                    ...
                    className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                      activeReviewIndex === idx ? "bg-brand scale-120 w-5" : "bg-zinc-800 hover:bg-zinc-650"
                    }`}
      ...
      <section className="py-20 relative overflow-hidden bg-zinc-950 border-t border-zinc-900 text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-8">
          ...
          <p className="text-zinc-400 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed font-sans">
            Com as ferramentas métricas de alta performance, exames médicos integrados e o acompanhamento de quem é referência, você vai de vez abolir os erros que sabotavam o seu emagrecimento.
          </p>
      ...
      <section id="contato" className="bg-black text-zinc-400 py-16 border-t border-zinc-900 flex-col">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-xs sm:text-sm text-zinc-450 leading-relaxed font-sans">
              Sorocaba e Região possuem agora o padrão ouro em nutrologia esportiva, emagrecimento integrado e preparação física de alta performance. Agende com antecedência.
            </p>
            ...
            <div className="space-y-3.5 text-xs text-zinc-300">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <span>
                  Av. Comendador Pereira Inácio, 950<br />
                  6º Andar – Sala 661 – Jardim Vergueiro<br />
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="tel:1533592190" className="hover:text-white transition-colors">(15) 3359-2190</a>
              </div>
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <ul className="space-y-2 text-xs text-zinc-450 font-sans">
              <li className="flex justify-between"><span>Segunda a Quinta:</span> <span className="text-zinc-300 font-bold">08:00 – 19:00</span></li>
              <li className="flex justify-between"><span>Sexta-Feira:</span> <span className="text-zinc-300 font-bold">08:00 – 18:00</span></li>
              <li className="flex justify-between"><span>Sábado / Domingo:</span> <span className="text-zinc-550">Fechado</span></li>
            </ul>
            <p className="text-[10px] text-zinc-550 italic">
              *Atendimento particular com laudo InBody completo e prescrição médica para acompanhamento de exames laboratoriais.
            </p>
          </div>
          ...
          <div className="lg:col-span-4 space-y-4 text-left">
            ...
            <p className="text-xs text-zinc-450 leading-relaxed font-sans">
              Acompanhe posts científicos diários e dicas de rotina e nutrição prática compartilhados pelo Dr. Fábio Pizzini:
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-zinc-900/60 text-center flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-zinc-650 font-mono">
          <p>© {new Date().getFullYear()} Clínica Dr. Fábio Pizzini. Todos os direitos reservados.</p>
